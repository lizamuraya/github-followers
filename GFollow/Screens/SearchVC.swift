...
class SearchVC: UIViewController {
    ...
    let callToActionButton = GFButton(color: .systemGreen, title: "Get Followers", systemImageName: "p")
    ...
    @objc func pushFollowerListVC() {
        guard isUsernameEntered else {
            DispatchQueue.main.async {
                self.presentGFAlert(title: "Empty Username", message: "Please enter a username 😁", buttonTitle: "Okay")
            }
            return
        }
        ...
        let followerListVC = FollowerListVC(username: userTextField.text ?? "")
